 ...
 * - Ace Editor (ace.js)
 */
// @koala-prepend "editor-vendor/emmet.js"
// @koala-prepend "editor-vendor/ace/ace.js"
// @koala-prepend "editor-vendor/ace/ext-emmet.js"
// @koala-prepend "editor-vendor/ace/ext-language_tools.js"
// @koala-prepend "editor-vendor/ace/ext-rtl.js"
// @koala-prepend "editor-vendor/ace/mode-php.js"
// @koala-prepend "editor-vendor/ace/mode-twig.js"
// @koala-prepend "editor-vendor/ace/mode-markdown.js"
// @koala-prepend "editor-vendor/ace/mode-plain_text.js"
// @koala-prepend "editor-vendor/ace/mode-less.js"
// @koala-prepend "editor-vendor/ace/mode-css.js"
// @koala-prepend "editor-vendor/ace/mode-scss.js"
// @koala-prepend "editor-vendor/ace/mode-sass.js"
// @koala-prepend "editor-vendor/ace/mode-yaml.js"
// @koala-prepend "editor-vendor/ace/mode-javascript.js"
...
+(function ($) {
    ...
    CodeEditor.prototype.init = function () {
        ...
        editor.renderer.setHScrollBarAlwaysVisible(
            options.hScrollBarAlwaysVisible
        );
        ...
        this.$fullscreenEnable.on(
            "click.codeeditor",
            ">a",
            $.proxy(this.toggleFullscreen, this)
        );
        this.$fullscreenDisable.on(
            "click.codeeditor",
            ">a",
            $.proxy(this.toggleFullscreen, this)
        );
        ...
        this.$searchboxEnable.on(
            "click.codeeditor",
            ">a",
            $.proxy(this.toggleSearchbox, this)
        );
        this.$searchboxDisable.on(
            "click.codeeditor",
            ">a",
            $.proxy(this.toggleSearchbox, this)
        );
        ...
        this.$replaceboxEnable.on(
            "click.codeeditor",
            ">a",
            $.proxy(this.toggleReplacebox, this)
        );
        this.$replaceboxDisable.on(
            "click.codeeditor",
            ">a",
            $.proxy(this.toggleReplacebox, this)
        );
    ...
    CodeEditor.prototype.setTheme = function (theme) {
        ...
        assetManager.load(
            {
                js: [this.options.vendorPath + "/theme-" + theme + ".js"],
            },
            function () {
    ...
    $.fn.codeEditor = function (option) {
        ...
        this.each(function () {
            ...
            if (!data)
                $this.data(
                    "oc.codeEditor",
                    (data = new CodeEditor(this, options))
                );
    ...
    +(function (exports) {
        if (exports.ace && typeof exports.ace.require == "function") {
            ...
            if (
                emmetExt &&
                emmetExt.AceEmmetEditor &&
                emmetExt.AceEmmetEditor.prototype.getSyntax
            ) {
